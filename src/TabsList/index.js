...
class TabsList extends Component {
  state = {
    ...
    isTrue: false,
    score: 0,
    firstUrl: imagesList[0].imageUrl,
  }
  ...
  resettingGame = () => {
    this.timerId = setInterval(this.statusChange, 1000)
    this.setState({isTrue: false, time: 60, score: 0})
  }
        ...
        <nav className="heading-1">
          <div className="match_image_logo">
            <img
              ...
              alt="website logo"
              className="gamesizing"
            />
          </div>
          <div className="score_timer">
            <p className="score_white">
              score: <span className="darkening">{score}</span>
            </p>
